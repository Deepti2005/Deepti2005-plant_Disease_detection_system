...
# Color Palette
primary_color = "#2D6A4F"  # Green
accent_color = "#F4A300"   # Vibrant Yellow
background_color = "linear-gradient(135deg,rgb(138, 231, 189),rgb(220, 137, 79))"  # Green-brown gradient
button_color = "linear-gradient(135deg,rgb(14, 67, 171),rgb(228, 17, 211))"  # Deep green button
